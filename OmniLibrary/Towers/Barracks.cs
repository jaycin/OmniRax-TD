...
{
    public class Barracks :GameObject
    {
        #region fields
        Texture2D image;
        ...
        #region Constructors
        public Barracks(Texture2D image,Texture2D selectedImage, Rectangle destination, float scale)
        {
            Image = image;
        ...
        public Barracks(Texture2D image, Texture2D selectedImage, Rectangle destination, Rectangle source, float scale)
        {
            Image = image;
            destRect = destination;
            SourceRect = source;
