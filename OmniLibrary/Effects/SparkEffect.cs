...
{
    public class SparkEffect : GameObject
    {
        ...
        #region Constructors
        public SparkEffect(Texture2D image, Vector2 position, int imageRows, int imageCollumns, float scale, int State, int faceing)
        {
            Facing = faceing;
            state = State;
            state = 0;
